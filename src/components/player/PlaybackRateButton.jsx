...
export function PlaybackRateButton({ player }) {
  ...
  return (
    <button
      type="button"
      className="relative flex h-6 w-6 items-center justify-center rounded-md text-cool-gray-500 hover:bg-cool-gray-100 hover:text-cool-gray-700 focus:outline-none focus:ring-2 focus:ring-cool-gray-400 focus:ring-offset-2"
      onClick={() => {
