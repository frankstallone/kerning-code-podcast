...
import posterImage from '@/images/nextjs-poster@2x.png'
...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      <h2 className="flex items-center font-mono text-sm font-medium leading-7 text-cool-gray-900">
        <TinyWaveFormIcon
          colors={['fill-faded-brass-300', 'fill-faded-brass-500']}
      ...
      <p
        className={clsx(
          'mt-2 text-base leading-7 text-cool-gray-700',
      ...
      {!isExpanded && (
        <button
          type="button"
          className="mt-2 hidden text-sm font-bold leading-6 text-cool-gray-500 hover:text-cool-gray-700 active:text-cool-gray-900 lg:inline-block"
...
export function Layout({ children }) {
  let hosts = ['Frank Stallone', 'Chuck Lafferty']

  return (
    <>
      <header className="bg-cool-gray-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-112 lg:items-start lg:overflow-y-auto xl:w-120">
        <div className="hidden lg:sticky lg:top-0 lg:flex lg:w-16 lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12 lg:text-sm lg:leading-7 lg:[writing-mode:vertical-rl]">
          <span className="font-mono text-cool-gray-500">Hosted by</span>
          <span className="mt-6 flex gap-6 font-bold text-cool-gray-900">
            {hosts.map((host, hostIndex) => (
              <Fragment key={host}>
                {hostIndex !== 0 && (
                  <span aria-hidden="true" className="text-cool-gray-400">
                    /
                  </span>
                )}
                {host}
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-cool-gray-200 lg:py-12 lg:px-8 xl:px-12">
          <Link
            href="/"
            className="relative mx-auto block w-48 overflow-hidden rounded-lg bg-cool-gray-200 shadow-xl shadow-cool-gray-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
            aria-label="Homepage"
          >
            <Image
              className="w-full"
          ...
          <div className="mt-10 text-center lg:mt-12 lg:text-left">
            <p className="text-xl font-bold text-cool-gray-900">
          ...
          <section className="mt-10 lg:mt-12">
            <h2 className="sr-only flex items-center font-mono text-sm font-medium leading-7 text-cool-gray-900 lg:not-sr-only">
              <TinyWaveFormIcon
                colors={['fill-faded-brass-300', 'fill-faded-brass-500']}
                className="h-2.5 w-2.5"
              />
            ...
            <div className="h-px bg-gradient-to-r from-cool-gray-200/0 via-cool-gray-200 to-cool-gray-200/0 lg:hidden" />
            <ul
              role="list"
              ...
              {[
                ...
                <li key={label} className="flex">
                  <Link
                    ...
                    aria-label={label}
                  >
                    <Icon className="h-8 w-8 fill-cool-gray-400 group-hover:fill-cool-gray-600" />
      ...
      <main className="border-t border-cool-gray-200 lg:relative lg:mb-28 lg:ml-112 lg:border-t-0 xl:ml-120">
        <Waveform className="absolute left-0 top-0 h-20 w-full" />
        <div className="relative">{children}</div>
      </main>
      <footer className="bg-cool-gray-50 border-t border-cool-gray-200 py-10 pb-40 sm:py-16 sm:pb-32 lg:hidden">
        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4">
          <AboutSection />
          <h2 className="mt-8 flex items-center font-mono text-sm font-medium leading-7 text-cool-gray-900">
            <PersonIcon className="h-3 w-auto fill-cool-gray-300" />
            <span className="ml-2.5">Hosted by</span>
          </h2>
          <div className="mt-2 flex gap-6 text-sm font-bold leading-7 text-cool-gray-900">
            {hosts.map((host, hostIndex) => (
              <Fragment key={host}>
                {hostIndex !== 0 && (
                  <span aria-hidden="true" className="text-cool-gray-400">
